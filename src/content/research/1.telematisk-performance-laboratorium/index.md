---
title: Telematisk Performance Laboratorium
date: 2004–2005
lead: Three practice-led research laboratories on telematic presence, scenography and the situating of experience.
tags:
  - Research
  - Practice-led
  - Telematic Presence
...
publications:
  - title: Telematisk Performance Laboratorium — Folder
    ...
    type: Folder
    language: Danish
  - title: Kanonhallen — Floor plan
    file: kanonhallen-plan.pdf
    year: 2005
    type: Architectural plan
appearances:
  - date: November 2004
    occasion: Telematic Performance Laboratory I
    place: Kanonhallen, Copenhagen
    url: https://teaterleksikon.lex.dk/Boxiganga
  - date: February 2005
    occasion: Telematic Performance Laboratory II
    place: Kanonhallen, Copenhagen
    url: https://teaterleksikon.lex.dk/Boxiganga
  - date: June 2005
    occasion: Telematic Performance Laboratory III
    place: Kanonhallen, Copenhagen
    url: https://teaterleksikon.lex.dk/Boxiganga
  - date: June–July 2005
...
We saw the minimally staged situations as _situational arguments_ about human presence and relationships — each setup a configuration of bodies, light, optics and time-delay holding a single phenomenal question. Nothing in a setup was decorative; the mirrors, screens, cameras and projectors weren't production elements around an underlying performance, they were the situation itself. What a setup did to the person inside it was what the setup meant.
...
![Sharp lightroom and diffuse lightroom](setups/01.sharp-lightroom-and-diffuse-lightroom.jpg)
...
![Sharp lightroom and diffuse lightroom with mirror](setups/02.sharp-lightroom-and-diffuse-lightroom-mirror.jpg)
...
![Single frame double lightroom](setups/03.single-frame-double-lightroom.jpg)
...
![Video phone](setups/04.video-phone.jpg)
...
![Real you projected me](setups/05.real-you-projected-me.jpg)
...
![Real you projected you](setups/06.real-you-projected-you.jpg)
...
![Double lightroom and mirror](setups/07.double-lightroom-and-mirror.jpg)
...
![Lightroom with mirror and projection](setups/08.lightroom-with-mirror-and-projection.jpg)
...
![Delay videophone with table and chair](setups/09.delay-videophone-with-table-and-chair.jpg)

**9. Delay videophone with table and chair** — A video phone in which the return image is delayed by a few seconds. The table and chair work as a fixation mechanism: sitting down brings the two sides into a more visibly similar situation, and with the delay this can collapse into a mirrored symmetric experience of a simultaneous _now_. For some participants this became an active study, working delay-synchronised loops of gesture to collapse the perception of the delay circuit into an experienced simultaneousness. The matched furniture on both sides also makes the locality of the image ambiguous; with the delay, some participants lost track of whether they were watching themselves or the opposite room.

</figure>

<figure class="setup">

![Crossed delay projections for dance](setups/10.crossed-delay-projections-for-dance.jpg)
...
![Mirrechophone](setups/11.mirrechophone.jpg)
...
![Videophone with table and chair](setups/12.videophone-with-table-and-chair.jpg)
...
![Single frame double lightroom with table and chair](setups/13.single-frame-double-lightroom-with-table-and-chair.jpg)
